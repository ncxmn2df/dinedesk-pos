...
// ---- Menu Items (Real Dish Photography - Local Assets) ----
export const mockMenuItems = [
  // Indian
  { id: 'ITEM-101', name: 'Butter Chicken', price: 320, category: 'indian', isVeg: false, image: 'assets/images/food/butter-chicken.jpg', emoji: '🍛', prepTime: 20, available: true, description: 'Tender chicken simmered in rich creamy tomato butter gravy with aromatic spices' },
  { id: 'ITEM-102', name: 'Paneer Tikka', price: 260, category: 'indian', isVeg: true, image: 'assets/images/food/paneer-tikka.jpg', emoji: '🧀', prepTime: 15, available: true, description: 'Charcoal-grilled cottage cheese cubes marinated in spiced yogurt and herbs' },
  { id: 'ITEM-103', name: 'Chicken Biryani', price: 280, category: 'indian', isVeg: false, image: 'assets/images/food/chicken-biryani.jpg', emoji: '🍚', prepTime: 25, available: true, description: 'Fragrant aged basmati rice cooked on dum with marinated chicken and saffron' },
  { id: 'ITEM-104', name: 'Dal Makhani', price: 220, category: 'indian', isVeg: true, image: 'assets/images/food/dal-makhani.jpg', emoji: '🥘', prepTime: 20, available: true, description: 'Slow-cooked whole black lentils simmered overnight with butter and fresh cream' },
  { id: 'ITEM-105', name: 'Butter Naan', price: 45, category: 'indian', isVeg: true, image: 'assets/images/food/dal-makhani.jpg', emoji: '🫓', prepTime: 5, available: true, description: 'Traditional clay-tandoor blistered leavened flatbread brushed with melted butter' },
  { id: 'ITEM-106', name: 'Garlic Naan', price: 60, category: 'indian', isVeg: true, image: 'assets/images/food/dal-makhani.jpg', emoji: '🧄', prepTime: 5, available: true, description: 'Tandoor flatbread infused with roasted minced garlic, coriander, and butter' },
  { id: 'ITEM-107', name: 'Tandoori Chicken', price: 340, category: 'indian', isVeg: false, image: 'assets/images/food/butter-naan.jpg', emoji: '🍗', prepTime: 25, available: true, description: 'Half chicken marinated in Kashmiri red chili and yogurt, roasted in tandoor' },

  // Pizza
  { id: 'ITEM-201', name: 'Margherita Pizza', price: 249, category: 'pizza', isVeg: true, image: 'assets/images/food/farmhouse-pizza.jpg', emoji: '🍕', prepTime: 18, available: true, description: 'San Marzano tomato sauce, fresh mozzarella cheese, and basil on hand-stretched crust' },
  { id: 'ITEM-202', name: 'Farmhouse Pizza', price: 299, category: 'pizza', isVeg: true, image: 'assets/images/food/farmhouse-pizza.jpg', emoji: '🍕', prepTime: 20, available: true, description: 'Loaded with bell peppers, red onions, mushrooms, black olives, and sweet corn' },
  { id: 'ITEM-203', name: 'Pepperoni Pizza', price: 349, category: 'pizza', isVeg: false, image: 'assets/images/food/pepperoni-pizza.jpg', emoji: '🍕', prepTime: 18, available: true, description: 'Artisanal sliced pepperoni layered over melted mozzarella and spiced marinara' },

  // Burgers
  { id: 'ITEM-301', name: 'Veg Burger', price: 149, category: 'burgers', isVeg: true, image: 'assets/images/food/veg-burger.jpg', emoji: '🍔', prepTime: 10, available: true, description: 'Crisp seasoned vegetable patty with lettuce, tomatoes, and house mayo on toasted brioche' },
  { id: 'ITEM-302', name: 'Chicken Burger', price: 189, category: 'burgers', isVeg: false, image: 'assets/images/food/chicken-burger.jpg', emoji: '🍔', prepTime: 12, available: true, description: 'Juicy spiced grilled chicken breast fillet with cheddar cheese and smoked paprika dressing' },
  { id: 'ITEM-303', name: 'Double Cheese Burger', price: 229, category: 'burgers', isVeg: false, image: 'assets/images/food/double-cheese-burger.jpg', emoji: '🍔', prepTime: 14, available: true, description: 'Double flame-grilled patties, double aged cheddar, caramelized onions, and house pickle' },

  // Snacks
  { id: 'ITEM-401', name: 'Masala Fries', price: 129, category: 'snacks', isVeg: true, image: 'assets/images/food/masala-fries.jpg', emoji: '🍟', prepTime: 8, available: true, description: 'Golden crispy skin-on potato fries dusted with peri-peri chaat masala spice blend' },
  { id: 'ITEM-402', name: 'Chicken Wings', price: 249, category: 'snacks', isVeg: false, image: 'assets/images/food/chicken-wings.jpg', emoji: '🍗', prepTime: 15, available: true, description: 'Crispy fried chicken wings tossed in tangy spicy barbecue glaze with ranch dip' },
  { id: 'ITEM-403', name: 'Paneer Tikka Bites', price: 199, category: 'snacks', isVeg: true, image: 'assets/images/food/paneer-tikka.jpg', emoji: '🧀', prepTime: 12, available: true, description: 'Bite-sized roasted cottage cheese cubes skewered with mint chutney drizzle' },
  { id: 'ITEM-404', name: 'Samosa (2 pcs)', price: 80, category: 'snacks', isVeg: true, image: 'assets/images/food/samosa.jpg', emoji: '🥟', prepTime: 5, available: true, description: 'Flaky golden pastry cones filled with spicy potato, green peas, and tamarind chutney' },

  // Drinks
  { id: 'ITEM-501', name: 'Cold Coffee', price: 149, category: 'drinks', isVeg: true, image: 'assets/images/food/cold-coffee.jpg', emoji: '☕', prepTime: 5, available: true, description: 'Blended espresso with chilled creamy milk, chocolate drizzle, and vanilla ice cream scoop' },
  { id: 'ITEM-502', name: 'Mango Lassi', price: 129, category: 'drinks', isVeg: true, image: 'assets/images/food/mango-lassi.jpg', emoji: '🥭', prepTime: 5, available: true, description: 'Thick Alphonso mango puree blended with chilled artisan yogurt and cardamom' },
  { id: 'ITEM-503', name: 'Fresh Lime Soda', price: 89, category: 'drinks', isVeg: true, image: 'assets/images/food/fresh-lime-soda.jpg', emoji: '🍋', prepTime: 3, available: true, description: 'Sparkling club soda with freshly squeezed lime juice, mint leaves, and rock salt' },
  { id: 'ITEM-504', name: 'Masala Chai', price: 49, category: 'drinks', isVeg: true, image: 'assets/images/food/masala-chai.jpg', emoji: '🫖', prepTime: 5, available: true, description: 'Authentic Indian Assam tea brewed with crushed ginger, green cardamom, and fresh milk' },

  // Pasta
  { id: 'ITEM-601', name: 'Pasta Alfredo', price: 249, category: 'pasta', isVeg: true, image: 'assets/images/food/pasta-alfredo.jpg', emoji: '🍝', prepTime: 15, available: true, description: 'Fettuccine pasta in rich creamy garlic butter parmesan sauce with sautéed mushrooms' },
  { id: 'ITEM-602', name: 'Penne Arrabbiata', price: 229, category: 'pasta', isVeg: true, image: 'assets/images/food/penne-arrabbiata.jpg', emoji: '🍝', prepTime: 15, available: true, description: 'Al dente penne in fiery plum tomato sauce, garlic, red chili flakes, and extra virgin olive oil' },

  // Desserts
  { id: 'ITEM-701', name: 'Gulab Jamun', price: 99, category: 'desserts', isVeg: true, image: 'assets/images/food/chocolate-brownie.jpg', emoji: '🍩', prepTime: 5, available: true, description: 'Warm khoya dumplings soaked in rose and saffron sugar syrup, garnished with pistachios' },
  { id: 'ITEM-702', name: 'Chocolate Brownie', price: 159, category: 'desserts', isVeg: true, image: 'assets/images/food/chocolate-brownie.jpg', emoji: '🍫', prepTime: 5, available: true, description: 'Warm Belgian dark chocolate walnut brownie served with vanilla bean ice cream' },
  { id: 'ITEM-703', name: 'Ras Malai', price: 129, category: 'desserts', isVeg: true, image: 'assets/images/food/chocolate-brownie.jpg', emoji: '🍮', prepTime: 5, available: true, description: 'Delicate cottage cheese discs steeped in condensed saffron milk and almond slivers' },

  // Salads
  { id: 'ITEM-801', name: 'Caesar Salad', price: 199, category: 'salads', isVeg: true, image: 'assets/images/food/caesar-salad.jpg', emoji: '🥗', prepTime: 8, available: true, description: 'Crispy romaine lettuce, herb croutons, and shaved parmesan tossed in creamy Caesar dressing' },
  { id: 'ITEM-802', name: 'Greek Salad', price: 179, category: 'salads', isVeg: true, image: 'assets/images/food/greek-salad.jpg', emoji: '🥗', prepTime: 8, available: true, description: 'Fresh cucumbers, tomatoes, bell peppers, Kalamata olives, and Greek feta in oregano vinaigrette' },

  // Chinese
  { id: 'ITEM-901', name: 'Veg Manchurian', price: 189, category: 'chinese', isVeg: true, image: 'assets/images/food/veg-manchurian.jpg', emoji: '🥡', prepTime: 15, available: true, description: 'Golden fried vegetable dumplings simmered in savory garlic, soy, and spring onion gravy' },
  { id: 'ITEM-902', name: 'Chicken Fried Rice', price: 219, category: 'chinese', isVeg: false, image: 'assets/images/food/chicken-fried-rice.jpg', emoji: '🍚', prepTime: 12, available: true, description: 'Wok-tossed long-grain rice with diced chicken, scrambled eggs, and seasonal vegetables' },
  { id: 'ITEM-903', name: 'Hakka Noodles', price: 179, category: 'chinese', isVeg: true, image: 'assets/images/food/veg-manchurian.jpg', emoji: '🍜', prepTime: 12, available: true, description: 'Wok-tossed noodles with crunchy julienne vegetables, white pepper, and light soy sauce' },
];
